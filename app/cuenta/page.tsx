  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '4px 0' }}>
        ...
        <span style={{ ...S, fontSize: '10px', color: 'rgba(245,240,232,0.25)' }}>o</span>
        <div style={{ flex: 1, height: '0.5px', background: 'rgba(245,240,232,0.1)' }} />
      </div>
      <button
        type="button"
        ...
        style={{ width: '100%', padding: '12px', background: 'transparent', border: '0.5px solid rgba(245,240,232,0.2)', borderRadius: '8px', color: 'rgba(245,240,232,0.7)', ...S, fontSize: '12px', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px', transition: 'border-color 150ms ease' }}
        onMouseEnter={(e) => { e.currentTarget.style.borderColor = 'rgba(245,240,232,0.35)' }}
